...
describe TaskMailer, type: :mailer do
  ...
  let(:task) { FactoryBot.create(:task, name: 'メーラーSpecを書く', description: '送信したメールの内容を確認します') }
